...
function publishExternalAPI(angular){
  ...
  在setupModuleLoader中有内部变量modules，每次创建一个module，都会以键值的方式赋值到modules上。modules内部结构为：
  modules
      ng
...
// doesn't know about moded locations and resolves URLs to the real document - which is
